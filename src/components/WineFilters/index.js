...
export class WineFilters {
    ...
    filterByBoldness(boldness, showBoldnessFilter) {
    ...
    applyFilters(filters, reset = false) {
        this.filtersReset = reset;
        this.wines = this.originalWines.filter(w => {
    ...
    resetFilters() {
        this.filters = { ...DEFAULT_FILTERS, selectedIcon: [] };
        this.wines = this.originalWines;
        this.filtersReset = true;
        return this.applyFilters(this.filters, true);
    }
}